 ...
 * Plugin URI: https://www.linkedin.com/in/amirolphat/
 * Description: کیف پول حساب کاربری. نسخه Fork شده (جهت حفظ سورس کد و از بین نرفتن موارد توسعه یافته، از بروزرسانی پلاگین پرهیز کنید.)
 * Author: امیر الفت
