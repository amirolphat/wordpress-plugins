...
Tested up to: 6.4
Stable tag: 1.4.10
Donate link: https://www.linkedin.com/in/amirolphat/
License: GPLv3
...
- Support [CURCY – Multi Currency for WooCommerce](https://amirolphat.ir/)
- Support [FOX – Currency Switcher Professional for WooCommerce](https://amirolphat.ir/)
...
> Experience the future of payments by trying our [demo](https://amirolphat.ir/).
...
If you get stuck, you can ask for help in the [WordPress Plugin Forum](https://amirolphat.ir) or just email us at amirolphat@gmail.com.

= Where can I report bugs or contribute to the project? =

Bugs can be reported either in our support forum or preferably on the [GitHub repository](https://github.com/amirolphat/wordpress-plugins).

= Where can I find the REST API documentation? =

You can find the documentation of our [Wallet REST API Docs](https://github.com/amirolphat/wordpress-plugins).

= This plugin is awesome! Can I contribute? =

Yes you can! Join in on our [GitHub repository](https://github.com/amirolphat/wordpress-plugins) :)
