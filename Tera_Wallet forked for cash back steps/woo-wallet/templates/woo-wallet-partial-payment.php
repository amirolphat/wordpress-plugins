	...
	<tr class="wallet-pay-partial">
		<th colspan="2">
			<label>
				...
				echo sprintf( __( '%1$s در کیف پول خود دارید و %2$s نیاز به تعیین تکلیف پرداخت دارد. ', 'woo-wallet' ), wc_price( $current_wallet_amount, woo_wallet_wc_price_args() ), wc_price( $rest_amount, woo_wallet_wc_price_args() ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
				?>
			</label>
		</th>
	</tr>
