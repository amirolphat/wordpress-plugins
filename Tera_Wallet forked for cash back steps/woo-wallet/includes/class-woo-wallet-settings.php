			...
			$settings_fields = array(
				...
				'_wallet_settings_credit'  => array_merge(
					array(
						...
						array(
							'name'  => 'cashback_amount2',
							'label' => __( 'مقدار بازگشت نقدی سطح 2', 'woo-wallet' ),
							'desc'  => __( 'Enter cashback amount', 'woo-wallet' ),
							'type'  => 'number',
							'step'  => '0.01',
						),
						...
						array(
							'name'  => 'min_cart_amount2',
							'label' => __( 'سطح دوم کش بک', 'woo-wallet' ),
							'desc'  => __( 'مقدار سطح دوم برای کش بک را وارد کنید.', 'woo-wallet' ),
							'type'  => 'number',
							'step'  => '0.01',
						),
						array(
